...
class Course(ABC):
    course_types=[]
    next_id = 1
    def __init__(self, name:str, teacher:str, department:str, course_type:str, units:int, class_times:list, class_room:str, exam_time:dict, exam_room:str, prerequisite:list):
        self.name = name
...
class Practical_course(Course):
    ...
    def __init__(self, name:str, teacher:str, department:str, course_type:str, units:int, class_times:list, class_room:str, exam_time:dict, exam_room:str, prerequisite:list, required_software:list, equipment_fee:int):
        super().__init__(name, teacher, department, course_type, units, class_times, class_room, exam_time, exam_room, prerequisite)
...
class Presentation_course(Course):
    ...
    def __init__(self, teacher:str, units:int, course_type:str='seminar'):
        super().__init__('presentation', teacher, 'default', course_type, units, [], 'default', {'day':'1405/01/01', 'time':'00:00'}, 'default', [])
